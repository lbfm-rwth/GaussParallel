...
M_height :=
    [2, 100, 5, 5, 200, 200, 1, 1, 1, 100, 200];;
M_width :=
    [2, 100, 5, 5, 200, 200, 1, 1, 100, 1, 50];;
M_numberBlocks_height :=
    [1, 5, 1, 1, 10, 4, 1, 1, 1, 100, 8];;
M_numberBlocks_width :=
    [1, 5, 1, 1, 10, 4, 1, 1, 100, 1, 2];;
M_q :=
    [7, 13, 5, 11, 17, 3, 11, 11, 5, 19, 7];;
