...
>               [1..30], [1..30], [1..30], [1..30]);
> if Length(Vectors(EchelonBasisMutableT(m))) = RankMat(m) then
>    Print(i, ", ");
> fi;
> od; Print("\n");
...
> res := EchelonBasisMutableT(permMat);
