...
GAUSS_WriteOutput := function(mat, a, b, nrColsPerBlockCol, nrRowsPerBlockRow, galoisField, D, R, M, E, K, withTrafo)
    local v, w, rank, tmp, B, C, heads, i, j, GlueR, result, rowBitstrings, colBitstrings;
